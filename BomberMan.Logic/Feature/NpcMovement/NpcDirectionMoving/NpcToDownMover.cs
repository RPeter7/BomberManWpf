...
{
    public class NpcToDownMover : INpcToDownMover
    {
        private readonly IGameModel _gameModel;
        private readonly IPositionFinder _positionFinder;
        private readonly INpcTurner _npcTurner;

        public NpcToDownMover(IGameModel gameModel, IPositionFinder positionFinder, INpcTurner npcTurner)
        {
        ...
        public bool MoveNpcDown(NonPlayableCharacter npc)
        {
